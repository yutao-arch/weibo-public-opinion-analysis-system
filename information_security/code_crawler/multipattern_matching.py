...
# 将所有微博连接成一个字符串
def all_weibo_to_string(all_weibo, data):
    for i in data['微博内容'].astype(str):
        # print(filter_emoji(l))
        # all_weibo = filter_emoji(all_weibo) + i
        all_weibo = all_weibo + i
    return all_weibo
